  ...
  try {
    const url = await axios
      ...
      .then((photos) => {
        ...
        footer.innerHTML = `<a href="https://instagram.com/${widgetSetting.id}" class="footer__button" target="_blank" style="background-color:${widgetSetting.color}">View on Instagram</a> `;
